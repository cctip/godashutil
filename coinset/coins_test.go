...
import (
	...
	"github.com/BlockABC/godashutil/coinset"
)

type TestCoin struct {
	TxHash     *wire.ShaHash
	TxIndex    uint32
	TxValue    godashutil.Amount
	TxNumConfs int64
}
...
var (
	...
	testSimpleCoinTxValue0            = godashutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = godashutil.NewTxFromBytes(testSimpleCoinTxBytes)
